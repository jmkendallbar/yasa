...
os.chdir("C:/Users/Jessie/Documents/Dissertation Sleep/R Analysis/Sleep Scoring Figure")
print("Current Working Directory ", os.getcwd())

# Load the EDF file, excluding the EOGs and EKG channels
raw = mne.io.read_raw_edf("V2_Land_Scoring_12_9_20_excerpt for figure.edf", preload=True, exclude=['MagZ'])
